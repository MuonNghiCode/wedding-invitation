...
const HeroSection = memo(
  forwardRef<HTMLDivElement, HeroSectionProps>((_, ref) => {
    ...
    return (
      ...
      >
        ...
        <h2 className="sr-only">
          Cặp đôi Minh Hương &amp; Kim Thuận - Lễ cưới 09/08/2025 tại White
          Palace Võ Văn Kiệt
        </h2>
        ...
        <div className="absolute inset-0 z-5 pointer-events-none">
          <div className="relative w-full h-full">
            ...
            >
              <picture>
                <source
                  srcSet="/backgrounds/hero-background-removebg.webp"
                  type="image/webp"
                />
                <img
